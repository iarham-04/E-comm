  ...
  return (
    <footer className="bg-slate-950 text-slate-400 pt-16 pb-12 border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-12 border-b border-slate-800/80 items-center">
          ...
          <div>
            {subscribed ? (
              <div className="bg-emerald-950/60 border border-emerald-500/40 text-emerald-300 text-xs p-3.5 rounded-xl font-medium">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3.5 py-2.5 text-xs bg-slate-900 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-400"
                  required
                />
                <button
                  type="submit"
                  className="bg-amber-500 text-slate-950 font-bold px-4 py-2.5 text-xs rounded-xl hover:bg-amber-400 transition-colors whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link href="/products?tag=new-arrivals" className="hover:text-white transition-colors">New Arrivals</Link></li>
              <li><Link href="/products?tag=best-sellers" className="hover:text-white transition-colors">Best Sellers</Link></li>
              <li><Link href="/products?tag=limited-edition" className="hover:text-white transition-colors">Limited Edition</Link></li>
            </ul>
          </div>

          {/* Column 2: Collections */}
          <div className="space-y-3">
            <h3 className="text-xs font-bold text-white uppercase tracking-wider">Collections</h3>
            <ul className="space-y-2 text-xs">
              <li><Link href="/collections/medieval" className="hover:text-white transition-colors">Medieval</Link></li>
              <li><Link href="/collections/viking" className="hover:text-white transition-colors">Viking</Link></li>
              <li><Link href="/collections/roman" className="hover:text-white transition-colors">Roman</Link></li>
              <li><Link href="/collections/home-decor" className="hover:text-white transition-colors">Home Décor</Link></li>
              <li><Link href="/collections/collectibles" className="hover:text-white transition-colors">Collectibles</Link></li>
            </ul>
          </div>

          {/* Column 3: Customer Service */}
          <div className="space-y-3">
            <h3 className="text-xs font-bold text-white uppercase tracking-wider">Customer Service</h3>
            <ul className="space-y-2 text-xs">
              <li><Link href="/contact-us" className="hover:text-white transition-colors">Contact</Link></li>
              <li><Link href="/faq" className="hover:text-white transition-colors">FAQs</Link></li>
              <li><Link href="/pages/shipping" className="hover:text-white transition-colors">Shipping</Link></li>
              <li><Link href="/pages/returns" className="hover:text-white transition-colors">Returns</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link href="/pages/sustainability" className="hover:text-white transition-colors">Sustainability</Link></li>
            </ul>
          </div>
          ...
          {/* Column 6: Social */}
          <div className="space-y-3">
            <h3 className="text-xs font-bold text-white uppercase tracking-wider">Social</h3>
            <ul className="space-y-2 text-xs">
