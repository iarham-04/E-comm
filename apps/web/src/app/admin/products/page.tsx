    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-neutral-200 pb-5 gap-4">
        <div>
          <Link
            href="/admin"
            className="text-xs font-bold text-neutral-500 hover:text-neutral-600 transition-colors"
          >
            ← Admin Dashboard
          </Link>
          ...
          <p className="text-xs text-neutral-500 mt-1">
            ...
            {lowStockCount > 0 && (
              <span className="text-neutral-700 font-bold ml-2 bg-neutral-50 border border-neutral-200 px-2 py-0.5 rounded-full inline-block">
      ...
      {/* Low Stock Alert */}
      {lowStockCount > 0 && (
        <div className="flex items-center space-x-3 bg-neutral-50 border border-neutral-200 rounded-2xl px-5 py-3.5 text-xs text-neutral-700">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-48">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-xs bg-white border border-neutral-200 rounded-xl text-neutral-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
          />
        </div>
      ...
      {/* Products Table */}
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-neutral-200/90 shadow-xs overflow-hidden">
                    ...
                    >
                      <td className="px-5 py-4 font-bold text-neutral-900">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <span className="line-clamp-1 max-w-56 text-neutral-900">{p.name}</span>
                      ...
                      <td className="px-5 py-4">
                        <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-neutral-100 border border-neutral-200 text-neutral-700">
                          {catName}
                        </span>
                      </td>
                      <td className="px-5 py-4 font-bold text-neutral-900">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            className={`w-16 p-1.5 border rounded-lg text-xs font-bold text-center focus:outline-none bg-white text-neutral-900 ${
                              isOutOfStock
                      ...
                      <td className="px-5 py-4 text-right space-x-2">
                        <Link
                          ...
                          target="_blank"
                          className="p-1.5 text-neutral-400 hover:text-neutral-800 transition inline-block"
                        ...
                        <Link
                          ...
                          className="p-1.5 text-neutral-400 hover:text-neutral-600 transition inline-block"
                          title="Edit Product"
                        >
                        ...
                        <button
                          ...
                          disabled={actionLoading === p.id}
                          className="p-1.5 text-neutral-400 hover:text-rose-600 transition inline-block"
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-12 text-neutral-500 text-xs">
            <Package className="w-8 h-8 mx-auto mb-2 opacity-40 text-neutral-600" />
