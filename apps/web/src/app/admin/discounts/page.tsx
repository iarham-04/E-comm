    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-200 pb-4">
        <div>
          ...
          <p className="text-xs text-neutral-400">Configure code-based coupons or automatic collection-wide sale events.</p>
        </div>
            ...
            {coupons.map((c) => (
              <tr key={c.id} className="hover:bg-[#fafafa]/50 transition-colors">
                ...
                <td className="py-3 px-4 text-right">
                  <button onClick={() => handleDelete(c.id)} className="p-1.5 bg-rose-950/60 hover:bg-rose-900 text-rose-600 rounded-lg transition-colors">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#fafafa] border border-neutral-200 rounded-2xl max-w-md w-full p-6 space-y-4 text-xs text-slate-100">
            <h2 className="font-bold text-base text-neutral-900">Create New Promotion</h2>

            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                <label className="block font-bold text-neutral-400 mb-1">Promotion Mode</label>
                <select
              ...
              {!form.isCollectionSale ? (
                <>
                  <div>
                    <label className="block font-bold text-neutral-400 mb-1">Coupon Code *</label>
                    <input
                      required
                      type="text"
                  ...
                  <div>
                    <label className="block font-bold text-neutral-400 mb-1">Min Order Value (₹)</label>
                    <input
                      type="number"
                ...
                <div>
                  <label className="block font-bold text-neutral-400 mb-1">Target Collection *</label>
                  <select
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-neutral-400 mb-1">Discount Type</label>
                  <select
                ...
                <div>
                  <label className="block font-bold text-neutral-400 mb-1">Value *</label>
                  <input
                    required
                    type="number"
                    min="1"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-neutral-400 mb-1">Starts At</label>
                  <input
                    type="date"
                    value={form.startsAt}
                ...
                <div>
                  <label className="block font-bold text-neutral-400 mb-1">Expires At</label>
                  <input
                    type="date"
              ...
              <div className="flex items-center justify-end space-x-3 pt-4 border-t border-neutral-200">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-neutral-900 text-white font-bold rounded-xl hover:bg-amber-400"
                >
                  Create Promotion
                </button>
              </div>
